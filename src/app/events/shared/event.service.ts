...
const EVENTS : IEvent[] = [
  ...
  },
  {
    ...
    export class EventService {
        ...
        pessoa=[{"Id":80,"Name":"Maria","CPF":"33076696807"}]
        getEventsTeste(): Observable<IEvent[]> {
          console.log('BBB')      
          return this.http.get<IEvent[]>('/api/events2').pipe(
            catchError(this.handleError<IEvent[]>('getEventsTeste',[]))
          )        
        }
